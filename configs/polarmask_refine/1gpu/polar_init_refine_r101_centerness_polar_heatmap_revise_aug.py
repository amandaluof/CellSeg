...
model = dict(
    ...
    # pretrained='/apdcephfs/private_amandaaluo/resnet101_caffe-3ad79236.pth',
    pretrained='https://openmmlab.oss-accelerate.aliyuncs.com/pretrain/third_party/resnet101_caffe-3ad79236.pth',
